...
def test_signup(pub_data):
    pub_data["username"]="自动生成 字符串 1,7 数字字母 x1"
...
data = excel_tool.get_test_case("D://充值接口.xls")
